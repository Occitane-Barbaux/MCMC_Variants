...
def Summary_run(draw,accept,n_mcmc_drawn,q_l=0.05,q_h=0.95):
...
def Summary_run_table(pathOut,model_name,draw,accept,n_mcmc_drawn,true_theta,MLE_theta,q_l=0.05,q_h=0.95,coef=['loc0' ,'loc1', 'scale0', 'scale1' ,'shape0'],show=True,Simulated=True):
	...
	with open(pathOut+"Table_"+model_name+".txt", "w") as outf:
...
def Para_Runs(pathOut,draw,true_theta,MLE_theta,prior_mean,model_name,n_mcmc_drawn,prior_law,show=True):
